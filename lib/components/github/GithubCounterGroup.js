...
var GithubCounterGroup = exports.GithubCounterGroup = function GithubCounterGroup(_ref) {
  ...
  return _react2.default.createElement(
    'div',
    { style: styles.group, className: 'github-counter-group', onClick: handleClick },
    _react2.default.createElement(
      'span',
      { style: styles.emoji, className: 'github-counter-group__emoji' },
      emoji
    ),
    count,
    _react2.default.createElement(
      'div',
      { style: styles.tooltip, className: 'github-counter-group__tooltip' },
