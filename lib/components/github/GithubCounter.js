...
var GithubCounter = exports.GithubCounter = function GithubCounter(_ref) {
  var hover = _ref.hover,
      ...
      svgHeight = _ref$svgHeight === undefined ? 16 : _ref$svgHeight;
  ...
  return _react2.default.createElement(
    'div',
    { style: styles.counter, className: 'github-counter' },
    ...
    _react2.default.createElement(
      'div',
      { style: styles.add, className: 'github-counter__add-button', onClick: onAdd },
      _react2.default.createElement(
        'svg',
        { height: svgHeight, width: '7', viewBox: '0 0 7 16' },
        _react2.default.createElement('path', { d: 'M4 7V4H3v3H0v1h3v3h1V8h3V7H4z' })
      ),
      _react2.default.createElement(
        'svg',
        { height: svgHeight, width: '16', viewBox: '0 0 16 16' },
