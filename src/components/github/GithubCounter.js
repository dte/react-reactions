...
export const GithubCounter = ({ hover, counters, user, onSelect, onAdd, svgHeight = 16 }) => {
  const styles = reactCSS({
    'default': {
      counter: {
        height: '36px',
        borderTop: '1px solid #191f2c',
        borderRadius: '0px',
        display: 'flex',
        background: '#0e1219',
      },
  ...
  return (
    <div style={ styles.counter } className="github-counter">
      ...
      <div style={ styles.add } className="github-counter__add-button" onClick={ onAdd }>
        <svg height={ svgHeight } width="7" viewBox="0 0 7 16" >
          <path d="M4 7V4H3v3H0v1h3v3h1V8h3V7H4z"></path>
        </svg>
        <svg height={ svgHeight } width="16" viewBox="0 0 16 16" >
